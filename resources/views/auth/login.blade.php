...
@section('content')
  <!-- Flash Success -->
  @if(session() === 'success')
    <div class="max-w-md mx-auto mt-24 p-4 bg-green-100 text-green-800 rounded">
      {{ session() }}
    </div>
  @endif
  ...
  <div class="flex items-center justify-center min-h-screen px-4">
    <div class="w-full max-w-md bg-white dark:bg-gray-800 shadow-md rounded-lg p-8">
      <h1 class="text-3xl font-bold text-indigo-600 text-center mb-6">Welcome Back</h1>
      ...
      <p class="text-center text-lg text-gray-700 dark:text-gray-300 mt-6">
        Don't have an account?
        <a href="{{ route('show.register') }}" class="text-indigo-600 hover:underline">Create Account</a>
      </p>
    </div>
  </div>
